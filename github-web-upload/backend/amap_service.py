...
AMAP_NAV_MODE = {
    "walking": "walk", "bus": "bus", "subway": "bus", "transit": "bus",
    "taxi": "car", "biking": "ride", "bicycling": "ride", "driving": "car",
}
...
def build_amap_navigation_uri(
    ...
    nav_mode = AMAP_NAV_MODE.get(mode, "car")
...
async def get_route(
    ...
    try:
        ...
        # A transient timeout/rate-limit response must not poison the route
        # cache.  Cache only verified AMap results; callers may retry fallback
        # results immediately.
